...
import type { RadioSettings } from "@/db/schemas";
...
interface RadioState {
  ...
  /** Seeds volume/muted/shuffleEnabled/loopMode from the persisted AppSettings row. */
  hydrateFromSettings: (settings: RadioSettings) => void;
}
...
/** Writes the current volume/muted/shuffleEnabled/loopMode preferences through to AppSettings. */
function persistPreferences(state: RadioState) {
...
export const useRadioStore = create<RadioState>()(
  immer((set, get) => ({
    ...
    hydrateFromSettings: (settings: RadioSettings) =>
      set((s) => {
        s.volume = settings.volume;
        s.muted = settings.muted;
        s.shuffleEnabled = settings.shuffleEnabled;
