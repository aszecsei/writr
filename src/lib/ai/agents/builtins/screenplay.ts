...
- The reader bible's voice/ paths should record screenplay conventions: scene-heading style (INT./EXT. — LOCATION — DAY/NIGHT), action paragraph rhythm, character cues, parentheticals, dialogue tics.
