  ...
  return (
    <div className="space-y-1">
      ...
      <button
        ...
        className="block w-full rounded-md px-3 py-2 text-left text-sm text-zinc-600 transition-colors hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-900"
      >
        App Settings
      </button>
    </div>
