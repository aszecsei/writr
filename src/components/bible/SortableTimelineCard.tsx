...
export function SortableTimelineCard({
    ...
    return (
      ...
      >
        ...
        <input
          ...
          className="block w-full rounded-md border border-neutral-300 bg-white px-3 py-2 text-xs dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100"
        />
        <textarea
          value={description}
  ...
  return (
    <div
      ref={mergeRefs}
      className={`flex items-start gap-3 rounded-lg border bg-white px-4 py-4 transition-all duration-500 dark:bg-neutral-900 ${
        isDragSource
          ? "border-neutral-200 opacity-50 shadow-lg ring-2 ring-neutral-300 dark:border-neutral-800 dark:ring-neutral-600"
          : showHighlight
            ? "border-yellow-400 ring-2 ring-yellow-400 dark:border-yellow-500 dark:ring-yellow-500"
            : "border-neutral-200 dark:border-neutral-800"
      }`}
